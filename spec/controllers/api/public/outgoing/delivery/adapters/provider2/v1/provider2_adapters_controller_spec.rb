...
RSpec.describe Api::Public::Outgoing::Delivery::Adapters::Provider2::V1::Provider2AdaptersController, type: :controller do
  let(:subject){ Api::Public::Outgoing::Delivery::Adapters::Provider2::V1::Provider2AdaptersController.new }
  let(:message) do
    Message.create(
  ...
  describe '#send_message' do
    context 'when the message is sent successfully' do
      it 'sends a message to Provider2' do
